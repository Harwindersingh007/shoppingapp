...
import 'package:shopping_app/models/mattress_product.dart';

import '../models/listproduct.dart';
import '../widgets/carousel.dart';
import '../widgets/listitems.dart';

class MattressList extends StatefulWidget {
  const MattressList({Key? key}) : super(key: key);

  @override
  State<MattressList> createState() => _MattressListState();
}

class _MattressListState extends State<MattressList> {
  @override
  void initState() {
    super.initState();
    loadData();
...
class MattressItems extends StatelessWidget {
  const MattressItems({Key? key}) : super(key: key);
